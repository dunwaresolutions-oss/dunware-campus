...
Write-Host "    Campus is LAN-only. To allow off-site access, use the Start Menu:"
Write-Host "    'Campus - Remote Access Setup' (see docs\REMOTE_ACCESS_AND_YOUR_DATA.md)."
